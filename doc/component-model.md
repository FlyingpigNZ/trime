...
> flat IME package described in `doc/definition-schema.md`. Later sections
> that mention `standard/`, `shared-aux/`, or schema-layout packages are
> preserved for history and no longer match the current code.
